...
header <- dashboardHeader(
  title = tags$a(href = "",
                 tags$img(src = "C:\\Users\\Joseph\\Documents\\GitHub\\Data-LA-Repo-\\CleanStat\\sankey_shiny\\www\\seal_of_los_angeles.png", height = "45", width = "40",
                          style = "display: block; padding-top: 5px;"))
)

sidebar <- dashboardSidebar(
  sidebarMenu(
    menuItem("Heatmap", tabName = "Heatmap", icon = icon("bar-chart"))
  )
)
...
body <- dashboardBody(
  ...
  tags$body(id = "body"),
  includeCSS("C:\\Users\\Joseph\\Documents\\GitHub\\Data-LA-Repo-\\CleanStat\\sankey_shiny\\www\\custom.css"),
