...
# Load data
q2 <- read.csv("~/Documents/github/Data-LA-Repo-/CleanStat/Clean_Streets_Index_Grids_2016_Q2.csv")
q3 <- read.csv("~/Documents/github/Data-LA-Repo-/CleanStat/LACityCleanStat_Q32016_Grids.csv")
